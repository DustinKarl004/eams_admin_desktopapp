...
import { collection, getDocs } from "https://www.gstatic.com/firebasejs/10.7.1/firebase-firestore.js";
  ...
  async function fetchExamineeData(searchTerm = '') {
      try {
          ...
          const examineesSnapshot = await getDocs(collection(db, 'transferee_examinees_result'));
          const uploadDocumentsSnapshot = await getDocs(collection(db, 'transferee_stepfour_upload_documents'));
